...
function updatePlayer(pitch, roll, forwardSpeedMultiplier) {
    ...
    function init() {
        ...
        function animate() {
            ...
            // For this setup, we're assuming that either keyboard or gamepad input is handled separately
            // The `updatePlayer` function is called within the input handlers
